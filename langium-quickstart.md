...
* `src/server/logik.langium` -  the grammar definition of your language.
* `src/server/main.ts` - the entry point of the language server process.
* `src/server/logik-module.ts` - the dependency injection module of your language implementation. Use this to register overridden and added services.
* `src/server/logik-validator.ts` - an example validator. You should change it to reflect the semantics of your language.

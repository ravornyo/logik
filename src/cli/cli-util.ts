...
export async function extractAstDocument<T extends AstNode>(fileName: string, services: LangiumServices): Promise<LangiumDocument<T>> {
    return (await extractDocument(fileName, services)) as LangiumDocument<T>;
}
